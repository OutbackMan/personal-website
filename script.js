...
preloader_info["dom_elem_anim_frames"] = document.querySelectorAll("[class*=Preloader__AnimationFrame]");
preloader_info["num_anim_frames"] = preloader_info.dom_elem_anim_frames.length;
preloader_info["is_active"] = false;
preloader_info["anim_duration"] = 1300;
preloader_info["time_per_frame"] = preloader_info.num_anim_frames / preloader_info.anim_duration;
